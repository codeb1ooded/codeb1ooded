...
public interface Constants {
    ...
    // Skills strings
    String SKILL_ANDROID = "Android";
    String SKILL_GIT_GITHUB = "Git & Github";
    String SKILL_ALGORITHM = "Algorithm";
    String SKILL_DATABASES = "Databases";
    String SKILL_LINUX = "Linux";
    String SKILL_PYTHON_DJANGO = "Python & Django";
    String SKILL_PHP_XAMPP = "PHP & Xampp";
    String SKILL_JAVA = "Java";
    String SKILL_C_CPP = "C/C++";
    String SKILL_ETHICAL_HACKING = "Ethical Hacking";
    String SKILL_HTML_CSS_JS = "HTML, CSS & JS";
