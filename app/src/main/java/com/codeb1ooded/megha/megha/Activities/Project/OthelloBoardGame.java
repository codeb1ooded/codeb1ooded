 ...
 */
public class OthelloBoardGame extends AppCompatActivity implements URLs {
    ...
    public static class ProjectOthelloAdapter extends FragmentStatePagerAdapter implements Counts {
        private int numofScreens;
        public ProjectOthelloAdapter(FragmentManager fm) {
            super(fm);
            numofScreens = PROJECT_OTHELLO_FRAGMENTS;
        }
